...
class BlockBanner4 extends Module
{
	public $adv_link;
	public $adv_img;
	public $adv_imgname;
	...
	{
		$this->name = 'blockbanner4';
		$this->tab = 'Blocks';
		$this->version = 0.1;

		parent::__construct();

		$this->displayName = $this->l('Block Banner4');
		...
		$this->adv_link = htmlentities(Configuration::get('BLOCKADVERT_LINK5'), ENT_QUOTES, 'UTF-8');
	}
	...
	public function postProcess()
	{
		...
		if (Tools::isSubmit('submitAdvConf'))
		{
			...
			{
				Configuration::updateValue('BLOCKADVERT_LINK5', $link);
...
';
	...
	*/
	function hookHome($params)
	{
		...
		return $this->display(__FILE__, 'blockbanner4.tpl');
	}
