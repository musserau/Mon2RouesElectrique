...
class BlockBanner2 extends Module
{
	public $adv_link;
	public $adv_img;
	public $adv_imgname;
	...
	{
		$this->name = 'blockbanner2';
		$this->tab = 'Blocks';
		$this->version = 0.1;

		parent::__construct();

		$this->displayName = $this->l('Block Banner2');
		...
		$this->adv_link = htmlentities(Configuration::get('BLOCKADVERT_LINK3'), ENT_QUOTES, 'UTF-8');
	}


	function install()
	{
		Configuration::updateValue('BLOCKADVERT_LINK3', 'http://www.prestashop.com');
		if (!parent::install())
			return false;
	...
	public function postProcess()
	{
		...
		if (Tools::isSubmit('submitAdvConf'))
		{
			...
			{
				Configuration::updateValue('BLOCKADVERT_LINK3', $link);
...
';
	...
	*/
	function hookRightColumn($params)
	{
		...
		return $this->display(__FILE__, 'blockbanner2.tpl');
	}
