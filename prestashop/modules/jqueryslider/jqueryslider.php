...
class JQuerySlider extends Module
{
	/** @var max image size */
 	...
 	function __construct()
 	{
		...
		$this->page = basename(__FILE__, '.php');
	 	$this->displayName = $this->l('JQuerySlider Galery');
	 	$this->description = $this->l('Rotador de imagenes');
 	}
 	...
 	private function _displayForm()
 	{
      ...
      $this->_html .= '<h4>'.$this->l('Slider #').$i.'</h4>';
		...
		$this->_html .= '
            ...
            <div class="margin-form">
                 <input type="submit" name="submitUpdate" value="'.$this->l('Guardar').'" class="button" />
            </div>
          </div>
