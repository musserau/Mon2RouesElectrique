<?php /* Smarty version Smarty-3.0.7, created on 2011-11-24 10:32:19
         compiled from "C:\wamp\www\prestashop/themes/theme001/modules/blockcart/blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:86784ece0f23504df1-92901915%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f3d01cb9cd8631b60b268e0b643c21751e95afd' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop/themes/theme001/modules/blockcart/blockcart-json.tpl',
      1 => 1321696382,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '86784ece0f23504df1-92901915',
  'function' => 
  array (
  ),
...
?>{
'products': [
<?php if ($_smarty_tpl->getVariable('products')->value){?><?php  $_smarty_tpl->tpl_vars['product'] = new Smarty_Variable;
...
<?php echo html_entity_decode(ob_get_clean(),2,'UTF-8')?><?php }?>',
		'name':          '<?php echo smarty_modifier_escape(smarty_modifier_truncate(addslashes($_smarty_tpl->tpl_vars['product']->value['name']),16,'...',true),'htmlall','UTF-8');?>
',
...
',
		'link':            '<?php echo $_smarty_tpl->getVariable('base_dir_ssl')->value;?>
order.php?deleteDiscount=<?php echo $_smarty_tpl->tpl_vars['discount']->value['id_discount'];?>
',
		'price':           '-<?php if ($_smarty_tpl->getVariable('priceDisplay')->value==1){?><?php ob_start();?><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['discount']->value['value_tax_exc']),$_smarty_tpl);?>
