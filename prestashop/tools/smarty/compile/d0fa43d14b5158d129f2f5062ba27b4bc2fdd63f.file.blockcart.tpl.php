<?php /* Smarty version Smarty-3.0.7, created on 2011-11-24 10:32:18
         compiled from "C:\wamp\www\prestashop/themes/theme001/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:158984ece0f2255d292-09313790%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd0fa43d14b5158d129f2f5062ba27b4bc2fdd63f' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop/themes/theme001/modules/blockcart/blockcart.tpl',
      1 => 1321696382,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '158984ece0f2255d292-09313790',
  'function' => 
  array (
  ),
...
"><?php echo smartyTruncate(array('text'=>$_smarty_tpl->tpl_vars['product']->value['name'],'length'=>'10','encode'=>'true'),$_smarty_tpl);?>
				...
				<span class="remove_link"><?php if (!isset($_smarty_tpl->getVariable('customizedDatas',null,true,false)->value[$_smarty_tpl->getVariable('productId',null,true,false)->value][$_smarty_tpl->getVariable('productAttributeId',null,true,false)->value])){?><a class="ajax_cart_block_remove_link" href="<?php echo $_smarty_tpl->getVariable('base_dir')->value;?>
cart.php?delete&amp;id_product=<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
...
"><a class="ajax_cart_block_remove_link" href="<?php echo $_smarty_tpl->getVariable('base_dir')->value;?>
cart.php?delete&amp;id_product=<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
</span>x</span><?php if (isset($_smarty_tpl->tpl_vars['customization']->value['datas'][$_smarty_tpl->getVariable('CUSTOMIZE_TEXTFIELD',null,true,false)->value][0])){?><?php echo smartyTruncate(array('text'=>$_smarty_tpl->tpl_vars['customization']->value['datas'][$_smarty_tpl->getVariable('CUSTOMIZE_TEXTFIELD')->value][0]['value'],'length'=>'28','encode'=>'true'),$_smarty_tpl);?>
